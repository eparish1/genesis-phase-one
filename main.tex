...
artificial intelligence (AI) is poised to transform analysis and hypothesis-driven computational science workflows within DOE.
...
will provide the basis for RAG pipelines, feature engineering, validation, and the
...
repositories, prior studies, and internal technical materials. These sources include the types of technical
artifacts already used in prior team efforts such as FOAM-agent, which provide
an initial base for the open-source thread of the proposed work. The team is capable of collecting additional example workflows, validated input decks, etc., as needed. 

On the model side, the project will utilize generic APIs so that the framework can
